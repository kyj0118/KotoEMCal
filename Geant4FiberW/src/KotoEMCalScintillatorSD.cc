...
//
//
/// \file KotoEMCalScintillatorSD.cc
/// \brief Implementation of the KotoEMCalScintillatorSD class
...
KotoEMCalScintillatorSD::KotoEMCalScintillatorSD(G4String name, G4int nLayers, G4int nModulesXY)
...
KotoEMCalScintillatorSD::~KotoEMCalScintillatorSD() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void KotoEMCalScintillatorSD::Initialize(G4HCofThisEvent* hce) {
  fHitsCollection = new KotoEMCalScintillatorHitsCollection(fNameSD, collectionName[0]);
  if (fHCID < 0) {
...
G4bool KotoEMCalScintillatorSD::ProcessHits(G4Step* step, G4TouchableHistory*) {
...
void KotoEMCalScintillatorSD::EndOfEvent(G4HCofThisEvent* hce) {
  for (int i = 0; i < fNumberOfTotalModules; i++) {
    ...
    fHitsCollection->insert(new KotoEMCalScintillatorHit(fHCID));
    G4int CurrentHitID = fHitsCollection->GetSize() - 1;
    auto hit = (KotoEMCalScintillatorHit*)((hce->GetHC(fHCID))->GetHit(CurrentHitID));
