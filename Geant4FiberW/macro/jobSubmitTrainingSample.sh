...
for ((seed = 1; seed <= 20; seed++)); do
  ...
  optionOutput="-output=$outputPATH/electron1000MeV_${seed_prefix0}"
  bsub -q s ./KotoEMCal $optionEnergy $optionAngle $optionPosition $optionParticle $optionNEvents $optionSeed $optionOthers
done
