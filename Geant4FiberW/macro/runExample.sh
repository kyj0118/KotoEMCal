...
optionAngle="-angleOpt=fixed -theta=0 -phi=0"
optionPosition="-minX=-5 -maxX=5 -minY=-5 -maxY=5 -posZ=0"
optionNEvents="-nEvents=1000"
optionParticle="-particle=e-"
optionSeed="-seed=1"
optionOthers="-outFileName=test -useGPS=false"
./KotoEMCal $optionEnergy $optionAngle $optionPosition $optionParticle $optionNEvents $optionSeed $optionOthers
